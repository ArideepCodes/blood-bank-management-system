...
<div id="sidebar">
  <?php $active="blood_requests"; include 'sidebar.php'; ?>
</div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <?php
        ...
        $sql = "SELECT * FROM blood_requests ORDER BY id DESC LIMIT {$offset}, {$limit}";
      ...
      <?php } else { echo "<div class='alert alert-info'>No blood requests found yet.</div>"; } ?>
