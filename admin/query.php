  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <?php
        ...
        // ✅ Updated to new table and columns
        $sql = "SELECT * FROM contact_queries ORDER BY id DESC LIMIT {$offset}, {$limit}";
        ...
        <table class="table table-bordered" style="text-align:center">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="max-width:250px; word-wrap:break-word;"><?php echo $row['message']; ?></td>
              <td><?php echo $row['submitted_on']; ?></td>
              <td id="he" style="width:100px">
                <a style="background-color:aqua" href='delete_query.php?id=<?php echo $row['id']; ?>'>Delete</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
      ...
      <?php } else { echo "<div class='alert alert-info'>No queries found yet.</div>"; } ?>

      <div class="table-responsive" style="text-align:center;">
        <?php
          $sql1 = "SELECT * FROM contact_queries";
